...
**Установка:**
1. Распаковать архив
2. В папке `LersReportGeneratorPlugin`: **ПКМ на `install.bat` → Запустить от имени администратора**
...
2. В папке `LersReportProxy`: **ПКМ на `install.bat` → Запустить от имени администратора**
